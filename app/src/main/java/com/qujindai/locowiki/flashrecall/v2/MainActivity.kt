        ...
        setContent {
            ...
            MaterialTheme(colorScheme = lightColorScheme()) {
                FlashRecallScreen(
                    ...
                    onCaptureSelfSample = viewModel::captureSelfSample,
                    ...
                    onStartMeeting = { permissionLauncher.launch(Manifest.permission.RECORD_AUDIO) },
                    ...
                    onExportLatency = { exportLatencyLauncher.launch("locowiki-latency-v0.3.csv") },
                    onExportMeeting = { exportMeetingLauncher.launch("locowiki-meeting-v0.3.zip") },
                )
            }
        }
    }
